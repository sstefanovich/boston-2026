...
export const TIMELINE: TimelineDay[] = [
  {
    ...
    weekday: 'Saturday',
    where: 'Boston — arrive',
    highlights: 'UA1606 lands 2:02 PM · check-in 3 PM · Atlantic Fish 7 PM',
    theme: 'travel',
    image: CITY_IMAGES.travel,
    freeTime: 'After landing ~2:02 PM — Logan to Back Bay (~25–35 min) · hotel check-in 3 PM',
    dontMiss: [
  ...
  },
  {
    ...
    weekday: 'Tuesday',
    where: 'Boston · dinner',
    highlights: 'La Voile dinner 5:30 PM',
    theme: 'boston',
    image: CITY_IMAGES.boston,
    freeTime: 'Open day until dinner 5:30 PM',
    dontMiss: [
      dm(
  ...
  },
  {
    ...
    weekday: 'Wednesday',
    where: 'Depart Boston',
    highlights: 'Check out noon · UA472 departs 12:27 PM',
    theme: 'travel',
    image: CITY_IMAGES.travel,
    freeTime: 'Leave for Logan ~10:30 AM for 12:27 PM departure · check out by noon',
    dontMiss: [
...
export const CALENDAR_EVENTS: TripEvent[] = [
  ...
  },
  {
    ...
    location: 'Boston Logan (BOS)',
    address: '1 Harborside Dr, Boston, MA 02128',
    details: 'United · departs 12:27 PM · arrives ORD 2:20 PM Central',
    theme: 'travel',
