...
export const TIMELINE: TimelineDay[] = [
  ...
  },
  {
    ...
    date: 'Mon 10 Aug',
    weekday: 'Monday',
    where: 'North End · harbor',
    highlights: 'North End Food Tour 12 PM · waterfront · Charlestown',
    theme: 'northend',
    image: CITY_IMAGES.northend,
    freeTime: 'Before noon meetup · after tour ~3 PM',
    dontMiss: [
      dm(
      ...
      dm('Legal Sea Foods chowder', 'Legal Sea Foods State Street Boston'),
    ],
  ...
  },
  {
    ...
    highlights: 'Fenway or Cambridge day · add your plans',
    theme: 'cambridge',
